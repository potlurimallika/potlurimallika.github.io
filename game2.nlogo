  ...
  if mouse-down? and mouse-was-down = false [
    ...
    ask players [
       hatch-player-bullets 1[
        ...
        sound:play-note "Gunshot" 55 64 2
  ]
end
...
(Its a Enemy shooting video game)

## HOW IT WORKS

(Player and enemy planes shoots each other. Both of them need to survive. Who survives wins the game.)

## HOW TO USE IT

(We can use the model by pressing setup and then start by pressing play button. Player plane goes up, down, left, right and can shoot the enemy planes. Enemy planes also shoots player plane.)

## THINGS TO NOTICE

(Enemy plane shoots only when player plane reaches near their regions. when it moves back enemy planes go back to their spaces.)

## THINGS TO TRY

( To move up we can use shortcut key p, for down ; , for left l, for right ')

## EXTENDING THE MODEL

(May be we can block the bullets and player plane hiding under something can make it more complicated)

## NETLOGO FEATURES

(interesting features sound for gun shooting)

## RELATED MODELS

(games models in the NetLogo Models Library )

## CREDITS AND REFERENCES

(Thaprobane interactice channel)
@#$#@#$#@
default
true
0
